...
export function FarmerProfilePage() {
  ...
  const breakdown = [
    {
      label: "Identity",
      value: state.identity.done || user.verified ? 100 : 0,
    },
  ...
  return (
    <>
        ...
        <section className="card flex items-center gap-4 p-4">
          <div className="relative shrink-0">
            {user.avatar ? (
              ...
              <span className="flex h-[76px] w-[76px] items-center justify-center rounded-full bg-brand-50 text-brand-600">
            ...
            <button
              ...
              className="absolute -bottom-0.5 -right-0.5 flex h-8 w-8 items-center justify-center rounded-full bg-brand-600 text-white ring-2 ring-white transition hover:bg-brand-700"
            >
          ...
          <div className="min-w-0 flex-1">
            ...
            {user.verified ? (
              <p className="mt-0.5 flex items-center gap-1.5 text-[15px] font-bold text-brand-600">
                <svg viewBox="0 0 20 20" className="h-[18px] w-[18px]">
                  ...
                  <path
                    fill="#fff"
                    d="m8.9 12.7-2.4-2.4 1.1-1.1 1.3 1.3 3.5-3.5 1.1 1.1-4.6 4.6Z"
                  />
                </svg>
                Verified Farmer
              </p>
            ...
            <div className="mt-2 flex flex-wrap items-center gap-3">
              ...
              <span className="flex items-center gap-1 text-[15px] text-ink">
                ...
                <span className="text-ink-soft">
                  ({user.reviewCount ?? 0} review
                  {(user.reviewCount ?? 0) === 1 ? "" : "s"})
                </span>
              </span>
            </div>
          </div>
      ...
      >
        This clears your listings, orders and saved details from this device. It
        cannot be undone.
      </Modal>
    </>
  );
