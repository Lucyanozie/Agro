        ...
        return (
          <li key={c.id}>
            <Link
              to={`${basePath}/${c.id}`}
              className={cx(
                "flex items-center gap-3 px-4 py-3.5 transition hover:bg-brand-50/50",
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 flex items-center gap-1 text-[15px] text-ink-mute">
                  {mine ? (
                    last?.read ? (
                      <CheckCheck className="h-4 w-4 shrink-0 text-[#4A9BF5]" />
                    ) : (
              ...
              <div className="flex shrink-0 flex-col items-end gap-1.5">
                <span
                  className={cx(
                    ...
                    unread ? "text-brand-600" : "text-ink-mute",
                  )}
                >
